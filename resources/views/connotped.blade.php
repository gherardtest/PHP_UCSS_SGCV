       ...
       --}}
                ...
                <div class="form-group col-md-12">
                  <div class="col-md-3">
                      ...
                      <input type="text" class="form-control textform" id="nota_pedido_id" name="nota_pedido_id"  placeholder="Número de pedido">
                  </div>
                  <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                        ...
                        <input type="text" class="form-control textform" id="vendedor" name="vendedor"  placeholder="Nombre del vendedor">
                    </div>
                    <div class="col-md-3">
